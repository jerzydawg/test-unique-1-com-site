...
const STATE_TITLES = [
  ...
  "Get Free Phone in [STATE] | Government Benefits",
  "[STATE] Free Phone Program | Apply Online Now",
  "Free Government Phone Benefits in [STATE]",
  "Apply for Free Phone in [STATE] | Quick Start",
  "[STATE] Residents: Get Free Government Phone",
  "Free Phone Service Available in [STATE]",
  "[STATE] Free Government Phone | Enroll Today",
  "Access Free Phone Benefits in [STATE]",
  "Free Government Phone [STATE] | Qualify Now",
  "[STATE] Free Phone Application | Start Today",
  "Free Phone Benefits for [STATE] Residents",
  "Get Your Free Phone in [STATE] | Apply Now",
  "[STATE] Free Government Phone Service 2025",
  "Free Government Phone [STATE] | Check Eligibility",
  "Apply Free Phone Benefits in [STATE]",
  "[STATE] Free Phone Program | Get Started",
  "Free Government Phone [STATE] | No Cost",
  "[STATE] Residents: Free Phone Benefits",
  "Free Phone Service in [STATE] | Apply Fast",
  "Free Government Phone [STATE] | Enroll Online",
  "[STATE] Free Phone Benefits | Quick Apply",
  "Get Free Government Phone in [STATE]",
  "Free Phone Program [STATE] | Apply Today",
  "[STATE] Free Government Phone | Benefits Guide",
  "Free Government Phone [STATE] | Federal Program",
  "Apply for Free Phone in [STATE] | Easy Process",
  "[STATE] Free Phone Service | Get Benefits",
  "Free Government Phone [STATE] | Start Application",
  "Free Phone Benefits Available in [STATE]",
  "[STATE] Free Phone Enrollment | Apply Now",
  "Free Government Phone [STATE] | Program Info",
  "[STATE] Free Phone Benefits | Enroll Today",
  "Get Free Phone Service in [STATE]",
  "Free Government Phone [STATE] | Application",
  "[STATE] Free Phone Program | Benefits 2025",
  "Free Phone Service [STATE] | Apply Online",
  "[STATE] Free Government Phone | Get Started",
  "Free Government Phone [STATE] | Qualify Today",
  "[STATE] Free Phone Benefits | Start Now"
];
...
const CITY_TITLES = [
  ...
  "Get Free Phone in [CITY], [STATE] | Benefits",
  "[CITY] Free Government Phone | [STATE] Program",
  "Free Phone Service [CITY], [STATE] | Apply Now",
  "Free Government Phone [CITY] [STATE] | Enroll",
  "[CITY], [STATE] Free Phone Benefits | Apply",
  "Free Phone Program [CITY], [STATE] | Get Started",
  "[CITY] Residents: Free Government Phone [STATE]",
  "Free Government Phone [CITY] [STATE] | Qualify",
  "Apply for Free Phone [CITY], [STATE] | Today",
  "Free Phone Benefits [CITY], [STATE] | Quick Apply",
  "[CITY], [STATE] Free Phone Service | Apply",
  "Get Free Government Phone [CITY] [STATE]",
  "Free Phone [CITY], [STATE] | Government Benefits",
  "[CITY] Free Phone Program [STATE] | Apply Now",
  "Free Government Phone [CITY], [STATE] | 2025",
  "Free Phone Service Available [CITY], [STATE]",
  "[CITY], [STATE] Free Phone | Apply Online",
  "Free Government Phone [CITY] [STATE] | Start",
  "Free Phone Benefits for [CITY], [STATE] Residents",
  "Get Free Phone [CITY], [STATE] | Apply Today",
  "[CITY] Free Government Phone [STATE] | Enroll",
  "Free Phone Program [CITY], [STATE] | Benefits",
  "[CITY], [STATE] Free Phone Application | Now",
  "Free Government Phone [CITY] [STATE] | Check",
  "Apply Free Phone [CITY], [STATE] | Quick Start",
  "[CITY] Free Phone Service [STATE] | Get Benefits",
  "Free Phone [CITY], [STATE] | Federal Program",
  "[CITY], [STATE] Free Phone | No Cost Apply",
  "Free Government Phone [CITY] [STATE] | Guide",
  "Free Phone Benefits [CITY], [STATE] | Enroll",
  "[CITY] Free Phone [STATE] | Apply Online",
  "Free Government Phone [CITY], [STATE] | Qualify",
  "[CITY], [STATE] Free Phone Service | Benefits",
  "Get Free Phone [CITY] [STATE] | Apply Now",
  "Free Phone Program [CITY], [STATE] | Start",
  "[CITY] Free Government Phone [STATE] | Apply",
  "Free Phone [CITY], [STATE] | Government Program",
  "[CITY], [STATE] Free Phone Benefits | Enroll"
];
...
export function getMetaVariations(
  ...
  switch (pageType) {
    ...
    case 'state':
      // Include state name in hash salt to ensure uniqueness per location
      const stateSalt = stateName || '';
    ...
    case 'city':
      // Include city and state names in hash salt to ensure uniqueness per location
      const citySalt = [cityName, stateName].filter(Boolean).join('-');
